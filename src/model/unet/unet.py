"""UNet architecture for flow matching.

Copied from resources/CFM/unet/default.py — architecture preserved as-is.
Refactored to use BaseModel and model registry.
"""
...
from src.model.unet.modules import (
...
# Import registry and register at module level
